...
public abstract class SharedTests extends GWTTestCase
{
    ...
    @Test public void testUsingParentContext () {
        Object ctx = context("foo", context("bar", "1"), "bar", "2");
    ...
    @Test public void testDebugSeen() {
    ...
    @Test public void testPartialIndentationList() {
        test(Mustache.compiler().withLoader(new Mustache.TemplateLoader() {
            public Reader getTemplate (String name) {
                if (name.equals("foo")) {
        ...
        }), "(\n    1\n    2\n)", "(\n  {{>foo}}\n)", context("list", List.of(1, 2)));
    }

    @Test public void testPartialNestedEndingNewline() {
        test(Mustache.compiler().withLoader(new Mustache.TemplateLoader() {
            public Reader getTemplate (String name) {
                if (name.equals("foo")) {
                    return new StringReader("{{#bar}}\n  {{#foo}}{{.}}\n{{/foo}}{{/bar}}");
    ...
    @Test public void testPartialNestedEndingNewlineWrappedInNewlines() {
        test(Mustache.compiler().withLoader(new Mustache.TemplateLoader() {
            public Reader getTemplate (String name) {
                if (name.equals("foo")) {
                    return new StringReader("{{#bar}}\n{{#foo}}{{.}}\n{{/foo}}\n{{/bar}}");
